...
import {
  AVRTestHarness, assemble, LDI, OUT, RJMP,
} from './helpers/avrTestHarness';
...
describe('NPN LED switch — integration pipeline', () => {
  it('pin 9 toggled by AVR → PinManager → SPICE produces correct LED currents', { timeout: 60_000 }, async () => {
